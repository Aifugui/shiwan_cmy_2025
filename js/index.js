...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3||结束2024|2025|是|shiwan|与|梦妍|开启未来新的一年|回望2024|我们都在|自己的轨迹里|经受了很多|如|高考.|如|自我怀疑..|但|走过这山水一程|打过这|困难的|2024|发现|你才是|我打通|这关之后|最大的礼物|🎁||你才是|这位勇士身上|一件|坚硬的盔甲|爱你.|爱你..|梦妍..|。|。。|。。。|但是...|根据经验|在每次有了|更厉害的|装备后|都意味着.|更艰巨的。。|挑战!|所以.|你准备好|和我开启|2025里|全新的|365天了么？|做我的后盾|这一年|我们|认真守候|好吗..？|梦妍|#rectangle|');
...
S.init= function () {}
  ...
  if (i !== -1) {
      ...
      S.UI.simulate('|#countdown 3||欢迎2025|#rectangle|');
  }
